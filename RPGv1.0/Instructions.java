...
public class Instructions
{
     ...
     * on each corner.
     */
    private int[][] monsterArray = {{0,1,0}, //First
                                    {1,0,1}, //Second
                                    {1,1,3}}; //Third
    double maxYValue = 2;
    double maxXValue = 2;
...
*/
    ...
    {
        return monsterArray[0][1] == 0 && monsterArray[1][0] == 0 && monsterArray[1][2] == 0 && monsterArray[2][0] == 0 && monsterArray[2][1] == 0 && monsterArray[2][2] == 0;
    }
    /************************************************************************************************************************************************************************************************
     * **********************************************************************************************************************************************************************************************
     * **********************************************************************************************************************************************************************************************
